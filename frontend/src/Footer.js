    ...
    <footer style={{backgroundColor:"rgb(250,250,250)"}}>
      <div className="container border-top mt-5" >
        <div className="row mt-5">
          <div className="col">
            ...
            <div style={{display:"flex",alignItems: "center", gap:"5px"}}>
              <a href=""><img src="media\images\google-play-badge.svg" style={{width:"80%"}}/></a>
              <a href=""><img src="media\images\appstore-badge.svg" style={{width:"80%"}}/></a>
            </div>
          </div>
        ...
        <div className="mt-5 text-muted" style={{fontSize:"14px"}}>
          ...
          <p><a href="" style={{textDecoration:"none"}}>Smart Online Dispute Resolution | Grievances Redressal Mechanism </a><br/>
          ...
          <p>
            India's largest broker based on networth as per NSE. <a href="" style={{textDecoration:"none"}}>NSE broker factsheet</a><br/>
